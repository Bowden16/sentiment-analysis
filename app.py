...
st.set_page_config(page_title="Tailwind Logistics", page_icon="👍", layout="centered", initial_sidebar_state="auto")
#st.set_page_config(page_title="Tailwind Logistics", page_icon="")
...
def main():
  """Tailwind Logistics Cloud"""

  title_template = """
  <div style="background-color:blue; padding:8px;">
  <h1 style="color:cyan">Tailwind Logistics</h1>
  ...
  <h3 style="color:blue">Powered by Bowden Innovations</h1>
  </div>
  """
  ...
  if choice == "Translation":
    ...
    if len(raw_text) < 3:
      ...
      target_lang = st.selectbox("Target Language", ["Malay","German", "Spanish", "French", "English", "Italian"])
      if target_lang == "Malay":
        target_lang = "ms"
  ...
  if choice == "About":
    ...
    For more info:
    - [Bowden Innovations: Tailwind Applications](https://bowdeninnovations.io/tailwind-apps)
    """)
